//
//  TMEConversation+BackwardSupport.m
//  ThreeMin
//
...
@implementation TMEConversation (BackwardSupport)
...
+ (TMEConversation *)conversationFromData:(NSDictionary *)data{
    ...
    NSAssert(![data isKindOfClass:[NSDictionary class]], @"Data for conversation has to be NSDictionary class");
