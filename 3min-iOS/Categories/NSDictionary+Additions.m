...
{
  [self setValidObject:object forKey:[NSNumber numberWithInteger:key]];
}

- (void)setBOOL:(BOOL)boolValue forKey:(id <NSCopying>)key
{
    [self setValidObject:@(boolValue) forKey:key];
}
