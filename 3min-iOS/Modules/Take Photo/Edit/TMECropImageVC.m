...
@interface TMECropImageVC ()  <UIGestureRecognizerDelegate, IMGLYEditorCropMenuDelegate>
...
- (void)commonInitWithRect:(CGRect)rect {
    ...
    _selectionMode = TMECropImageVCSelectionModeFree;
    _cropRect = rect;
...
- (void)configureGUI {
    ...
    [self setSelectionMode:TMECropImageVCSelectionModeFree];
}
...
- (void)configureAnchors {
    _anchorImage = [UIImage imageNamed:@"crop_nubsi"];
...
- (void)reCalulateSizeForTopLeftAnchor:(CGFloat *)sizeX height:(CGFloat *)sizeY {
    if(self.selectionMode != TMECropImageVCSelectionModeFree) {
...
- (void)calculateRatioForSelectionMode:(TMECropImageVCSelectionMode)selectionMode {
    if(selectionMode == TMECropImageVCSelectionMode4to3) {
        _selectionRatio = 4.0 / 3.0;
    }
    else if(selectionMode == TMECropImageVCSelectionMode1to1) {
        _selectionRatio = 1.0;
    }
    else if(selectionMode == TMECropImageVCSelectionMode16to9) {
        _selectionRatio = 16.0 / 9.0;
    }
    if(selectionMode != TMECropImageVCSelectionModeFree) {
...
- (void)setSelectionMode:(TMECropImageVCSelectionMode)selectionMode {
    _selectionMode = selectionMode;
    [self calculateRatioForSelectionMode:selectionMode];
    [[self bottomView] setSelectionMode:(IMGLYSelectionMode)selectionMode];
}
...
- (void)squareFormButtonTouchedUpInside {
    [self setSelectionMode:TMECropImageVCSelectionMode1to1];
}

- (void)ratio4to3FormButtonTouchedUpInside {
    [self setSelectionMode:TMECropImageVCSelectionMode4to3];
}

- (void)ratio16to9FormButtonTouchedUpInside {
    [self setSelectionMode:TMECropImageVCSelectionMode16to9];
}
