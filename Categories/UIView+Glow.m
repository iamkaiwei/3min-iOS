...
static float GLOWVIEW_DEFAULT_INTENSITY = 0.6;
...
{
    if (intensity <= 0)
        intensity = GLOWVIEW_DEFAULT_INTENSITY;
...
{
    [self startGlowingWithColor:[UIColor whiteColor] fromIntensity:0 toIntensity:GLOWVIEW_DEFAULT_INTENSITY repeat:NO];
...
- (void)startGlowing
{
    [self startGlowingWithColor:[UIColor whiteColor] intensity:GLOWVIEW_DEFAULT_INTENSITY];
}
